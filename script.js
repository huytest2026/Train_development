...
window.startQuiz = function() {
    ...
    if (selectedMade) {
        ...
        // Kiểm tra xem có đang chọn chủ đề Động từ bất quy tắc hay không
        ...
        // Thiết lập số lượng câu hỏi chuẩn theo yêu cầu
        if (isIrregularVerbs) {
            targetCount = 10; // Đảm bảo Động từ bất quy tắc luôn là 10 câu
            totalSeconds = 10 * 60;
